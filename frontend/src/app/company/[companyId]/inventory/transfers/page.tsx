...
import { CreateStockTransfer, GetStockTransferHistory } from "@/actions/Inventory";
...
export default function StockTransfersPage() {
  ...
  const onSubmitNewTransfer = async (values: z.infer<typeof newTransferSchema>) => {
    try {
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => setIsNewTransferDialogOpen(true)}>New Transfer</Button>
      </div>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-6">
                      <div className="text-sm">
                        <p className="font-semibold">{transfer.sourceWarehouseName}</p>
                      ...
                      <div className="text-sm">
                        <p className="font-semibold">{transfer.destinationWarehouseName}</p>
      ...
      <Dialog open={isNewTransferDialogOpen} onOpenChange={setIsNewTransferDialogOpen}>
        <DialogContent>
          ...
          <Form {...newTransferForm}>
            <form onSubmit={newTransferForm.handleSubmit(onSubmitNewTransfer)} className="space-y-4">
              <FormField
              ...
              <div className="flex justify-end space-x-2">
                <Button type="button" variant="outline" onClick={() => setIsNewTransferDialogOpen(false)}>
                  Cancel
                </Button>
