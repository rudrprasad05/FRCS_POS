...
import { ApproveRefund } from "@/actions/Refund";
...
export default function ApproveRefundDialoge() {
  ...
  async function onSubmit(values: SignInFormType) {
    ...
    const res = await ApproveRefund(query, {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            To approve a refund, enter your credentials
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
