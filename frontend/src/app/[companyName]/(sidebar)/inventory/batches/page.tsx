...
import { GetProductBatchesByWarehouseId, CreateProductBatch, UpdateProductBatch, DeleteProductBatch } from "@/actions/Inventory";
...
export default function ProductBatchesPage() {
  ...
  useEffect(() => {
    const fetchBatches = async () => {
      ...
      try {
        ...
        const response = await GetProductBatchesByWarehouseId(warehouseId);
  ...
  const onSubmitUpdateBatch = async (values: z.infer<typeof updateBatchSchema>) => {
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => setIsNewBatchDialogOpen(true)}>Add New Batch</Button>
      </div>
      ...
      <Dialog open={isNewBatchDialogOpen} onOpenChange={setIsNewBatchDialogOpen}>
        <DialogContent>
          ...
          <Form {...newBatchForm}>
            <form onSubmit={newBatchForm.handleSubmit(onSubmitNewBatch)} className="space-y-4">
              <FormField
              ...
              <div className="flex justify-end space-x-2">
                <Button type="button" variant="outline" onClick={() => setIsNewBatchDialogOpen(false)}>
                  Cancel
                </Button>
      ...
      {/* Update Batch Dialog */}
      <Dialog open={isUpdateBatchDialogOpen} onOpenChange={setIsUpdateBatchDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Update Product Batch</DialogTitle>
          </DialogHeader>
          <Form {...updateBatchForm}>
            <form onSubmit={updateBatchForm.handleSubmit(onSubmitUpdateBatch)} className="space-y-4">
              <FormField
              ...
              <div className="flex justify-end space-x-2">
                <Button type="button" variant="outline" onClick={() => setIsUpdateBatchDialogOpen(false)}>
                  Cancel
                </Button>
