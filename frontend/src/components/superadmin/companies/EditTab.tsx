...
export function EditorTab({ company }: { company: Company }) {
  ...
  const onSubmit = async (data: EditCompanyData) => {
    ...
    const res = await EditCompany(data, company.uuid);

    if (res.success) {
      queryClient.invalidateQueries({
        queryKey: ["editCompany", company.uuid],
      });
      queryClient.invalidateQueries({
                      ...
                      <SelectContent className="w-full">
                        ...
                        <Link
                          href={{
                            ...
                            query: {
                              open_create: "true",
                              returnUrl: `/admin/companies/${company.uuid}/edit`,
                            },
                          }}
                        >
