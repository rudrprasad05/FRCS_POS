...
namespace FrcsPos.Interfaces
{
    public interface IRefundRepository
    {
        ...
        public Task<ApiResponse<RefundDTO>> ApproveRefundAsync(RequestQueryObject requestQuery, AdminApprovalRequest request);
        public Task<ApiResponse<RefundDTO>> RejectRefundAsync(RequestQueryObject requestQuery, AdminApprovalRequest request);
    }
}
